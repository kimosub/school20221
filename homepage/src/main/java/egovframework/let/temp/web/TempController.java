...
public class TempController {
	@Resource(name = "tempService") //상속을 여러개받을때 @Resource를 사용한다.
	private TempService tempService;
	
	//임시테이터 가져오기
	@RequestMapping(value = "/temp/select.do") // url만들기
	...
	public String insert(@ModelAttribute("serchVO") TempVO searchVO,
			HttpServletRequest request, ModelMap model) throws Exception{
